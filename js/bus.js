$(function() {
	...
	$("#bustart").attr("placeholder",datetime);
	$("#busend").attr("placeholder",datetime);
...
$(function() {
	for(var i = 0; i < pro.length; i++) {
		...
		$option.text(pro[i]);
		$(".busfrom .province").append($option);
	};
	$(".busfrom>label").click(function() {
		event.stopPropagation();
		$(".busfrom .province").css("display", "block");
	});
	$(".busfrom .province>li").click(function() {
		event.stopPropagation();
		$(".busfrom>input").val($(this).text());
		$(".busfrom .city").css("display", "block");
		$(".busfrom .city>li").empty();
		var cities = city[$(this).text()];
		for(var i = 0; i < cities.length; i++) {
			$option = $("<li></li>");
			$option.attr("value", cities[i]);
			$option.text(cities[i]);
			$(".busfrom .city").append($option);
		};
		$(".busfrom .city>li").click(function() {
			var txt = $(".busfrom>input").val();
			$(".busfrom>input").val(txt + " / " + $(this).text())
			$(".busfrom .province").css("display", "none");
			$(".busfrom .city").css("display", "none");
		});
	});
...
$(function() {
	for(var i = 0; i < pro.length; i++) {
		...
		$option.attr("value", pro[i]);
		$option.text(pro[i]);
		$(".busto .province").append($option);
	};
	$(".busto>label").click(function() {
		event.stopPropagation();
		$(".busto .province").css("display", "block");
	});
	$(".busto .province>li").click(function() {
		event.stopPropagation();
		$(".busto>input").val($(this).text());
		$(".busto .city").css("display", "block");
		$(".busto .city>li").empty();
		var cities = city[$(this).text()]
		for(var i = 0; i < cities.length; i++) {
			$option = $("<li></li>");
			$option.attr("value", cities[i]);
			$option.text(cities[i]);
			$(".busto .city").append($option);
		};
		$(".busto .city>li").click(function() {
			var txt = $(".busto>input").val();
			$(".busto>input").val(txt + " / " + $(this).text());
			$(".busto .province").css("display", "none");
			$(".busto .city").css("display", "none");
		});
	});
	$(document).click(function(event){
				$(".busto .province").css("display", "none");
